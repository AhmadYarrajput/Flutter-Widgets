...
class FrameworkPage extends StatefulWidget {
  ...
  const FrameworkPage({super.key, required this.onChipSelected});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Row(
        ...
        children: [
          selectedChipWidget(label: 'Ionic'),
          selectedChipWidget(label: 'Flutter'),
          selectedChipWidget(label: 'React Native'),
        ],
      ),
    );
  }
